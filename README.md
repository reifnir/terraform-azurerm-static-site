...
| Name | Description |
|------|-------------|
| <a name="output_azure_function_defualt_url"></a> [azure\_function\_defualt\_url](#output\_azure\_function\_defualt\_url) | The storage account's default DNS entry |
